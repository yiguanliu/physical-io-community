...
export const authEmailTemplates = [
 {name:'confirmation',subject:'Confirm your Physical I/O account',title:'Welcome to Physical I/O.',content:paragraph('Enter this one-time code on the member sign-in page to confirm your email address:')+code()+link('Or confirm my email','{{ .SiteURL }}/auth/confirm?token_hash={{ .TokenHash }}&amp;type=signup')+warning},
