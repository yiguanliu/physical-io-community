...
export async function deliverBatch(db:PoolClient,input:z.infer<typeof deliveryCommand>,actor:Actor,transport:EmailTransport=sendEmail,config=deliverySettings()){
