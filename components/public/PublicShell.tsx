  ...
  return <ThemeProvider theme={{ ...defaultTheme, mode: dark ? 'dark' : 'light' }}>
    <div className="public-site">
      ...
      <footer className="public-footer">
        ...
        <nav aria-label="Footer"><Link href="/about">About</Link><Link href="/events">Events</Link><Link href="/shop">Shop</Link><Link href="/join">Join the community</Link><Link href="/askusanything">Get in touch</Link></nav>
