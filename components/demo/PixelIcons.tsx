...
/* ---------------------------------------------------------------
   News thumbnails — one 16×16 tile per feed category, used both in
   the flat list overlay and in the article header on the screen.
   --------------------------------------------------------------- */
...
export type ThumbKey = keyof typeof NEWS_THUMBS;

/** Renders the 16×16 tile for a feed category. */
export function NewsThumb({ name, className }: { name: ThumbKey; className?: string }) {
  return <Bitmap rows={NEWS_THUMBS[name]} className={className} />;
}

/* ---------------------------------------------------------------
   Toolbar glyphs for news.exe (list/grid view, search).
   --------------------------------------------------------------- */
...
export function IconList({ className }: { className?: string }) {
  return <Bitmap rows={I_LIST} className={className} />;
}
export function IconGrid({ className }: { className?: string }) {
  return <Bitmap rows={I_GRID} className={className} />;
}
