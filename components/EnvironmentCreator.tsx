...
export default function EnvironmentCreator({value,onChange}:{value:EnvironmentSettings;onChange:(value:EnvironmentSettings)=>void}){
 ...
 <fieldset><legend>Lens</legend><Switch label="Depth of field" checked={value.depthOfField} onCheckedChange={v=>change('depthOfField',v)}/>{slider('Aperture','aperture',0,.02,.001)}</fieldset>
