...
export default function JoinFlow({profileRequired=false}:{profileRequired?:boolean}){
 ...
 function update(key:Key|'lastName',value:string|string[]){setValues(v=>({...v,[key]:value}));setError('');}
 function next(){
